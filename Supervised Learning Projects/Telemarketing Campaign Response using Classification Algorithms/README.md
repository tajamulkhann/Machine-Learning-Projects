# Telemarketing Campaign Response Classification

Predict whether a customer will subscribe to a term deposit using information available before a call concludes.
...
- **Goal:** Predict whether a customer will subscribe to a term deposit using information available before a call concludes.

## Dataset

- **Availability:** Included: `bank-additional-full-1.csv`
- **Recorded source:** UCI Bank Marketing dataset file is included in this project.
- **Target:** `y`
...
- The folder was corrected from regression to classification because the target is binary.
- Call duration is removed because it is only known after the call and would leak outcome information.
...
```text
├── telemarketing_response_classification.ipynb
├── README.md
...
jupyter lab 'telemarketing_response_classification.ipynb'
```
