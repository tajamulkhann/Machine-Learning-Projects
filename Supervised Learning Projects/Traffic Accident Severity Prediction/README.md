...
Predict severe accident risk to support planning—not automated enforcement—from weather and road context.
...
The notebook is committed with executed outputs. Open [traffic_accident_severity.ipynb](traffic_accident_severity.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "traffic_accident_severity.ipynb"
```
