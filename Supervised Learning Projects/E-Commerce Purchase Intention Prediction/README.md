...
Predict session conversion intent from browsing behavior for better experimentation and merchandising.
...
The notebook is committed with executed outputs. Open [ecommerce_purchase_intention.ipynb](ecommerce_purchase_intention.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "ecommerce_purchase_intention.ipynb"
```
