...
Predict payment default probability with calibrated evaluation and explicit responsible-lending limitations.
...
The notebook is committed with executed outputs. Open [credit_card_default_risk.ipynb](credit_card_default_risk.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "credit_card_default_risk.ipynb"
```
