...
Estimate flight fares from booking lead time, route, schedule, stops, and demand signals.
...
The notebook is committed with executed outputs. Open [flight_fare_prediction.ipynb](flight_fare_prediction.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "flight_fare_prediction.ipynb"
```
