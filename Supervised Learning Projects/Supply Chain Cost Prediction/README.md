...
Predict logistics cost for budgeting and network planning using operational, route, and service features.
...
The notebook is committed with executed outputs. Open [supply_chain_cost_prediction.ipynb](supply_chain_cost_prediction.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "supply_chain_cost_prediction.ipynb"
```
