...
Prioritize resumes for human review using transparent NLP features rather than opaque keyword filtering.
...
The notebook is committed with executed outputs. Open [ai_resume_screening_candidate_fit.ipynb](ai_resume_screening_candidate_fit.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "ai_resume_screening_candidate_fit.ipynb"
```
