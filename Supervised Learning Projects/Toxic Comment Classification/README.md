...
The notebook is committed with executed outputs. Open [toxic_comment_classification.ipynb](toxic_comment_classification.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
