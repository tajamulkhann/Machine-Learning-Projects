...
Predict near-term equipment failures from operating conditions with failure recall and intervention costs in view.
...
The notebook is committed with executed outputs. Open [predictive_maintenance_failure.ipynb](predictive_maintenance_failure.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "predictive_maintenance_failure.ipynb"
```
