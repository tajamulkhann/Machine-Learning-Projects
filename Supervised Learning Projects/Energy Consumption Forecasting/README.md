...
Forecast daily energy demand from weather, calendar, and lag features using time-aware validation.
...
- **Learning type:** Supervised forecast
- **Primary methods:** time-aware ridge and random-forest forecasting
...
The notebook is committed with executed outputs. Open [energy_consumption_forecasting.ipynb](energy_consumption_forecasting.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "energy_consumption_forecasting.ipynb"
```
