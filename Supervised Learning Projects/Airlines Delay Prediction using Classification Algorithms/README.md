...
Predict the dataset's delay class from airline, airport, time and flight-length features.
...
- **Goal:** Predict the dataset's delay class from airline, airport, time and flight-length features.

## Dataset

- **Availability:** Download required: place `airlines_delay.csv` in this directory
- **Recorded source:** [https://www.kaggle.com/datasets/ulrikthygepedersen/airlines-delay](https://www.kaggle.com/datasets/ulrikthygepedersen/airlines-delay)
- **Target:** `Class`
...
- Categorical encoders are fitted inside cross-validation folds.
- Flight identifiers are excluded because they are not reusable predictive signals.
...
```text
├── airline_delay_classification.ipynb
└── README.md
```
...
jupyter lab 'airline_delay_classification.ipynb'
```
