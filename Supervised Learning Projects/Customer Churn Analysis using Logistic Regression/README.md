...
Build an interpretable churn classifier centred on logistic regression and compare it with a dummy baseline.
...
- **Goal:** Build an interpretable churn classifier centred on logistic regression and compare it with a dummy baseline.

## Dataset

- **Availability:** Included: `customer churn.csv`
...
- The original folder was renamed because logistic regression solves a classification problem here.
- All customer features are processed inside one reproducible pipeline.
...
|---|---:|---:|
| Logistic Regression | 0.8055 | 0.7376 |
...
jupyter lab 'customer_churn_logistic_regression.ipynb'
```
