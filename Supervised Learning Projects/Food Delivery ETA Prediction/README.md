...
Predict delivery time from distance, preparation, traffic, weather, and courier context.
...
The notebook is committed with executed outputs. Open [food_delivery_eta.ipynb](food_delivery_eta.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "food_delivery_eta.ipynb"
```
