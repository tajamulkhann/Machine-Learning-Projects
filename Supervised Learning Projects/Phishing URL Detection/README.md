...
Flag suspicious URLs using character and token patterns, with recall emphasized for security triage.
...
The notebook is committed with executed outputs. Open [phishing_url_detection.ipynb](phishing_url_detection.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
