...
Classify customer feedback into satisfaction levels with transparent NLP baselines and class-aware metrics.
...
The notebook is committed with executed outputs. Open [customer_review_sentiment_classification.ipynb](customer_review_sentiment_classification.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
