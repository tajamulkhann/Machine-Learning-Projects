...
- **Target:** `Rainfall`
- **Primary metric:** MAE
- **Goal:** Estimate daily rainfall amount from same-day weather measurements.
...
- The duplicate classification notebook was corrected into a genuine regression project.
- RainToday, which is derived from rainfall, is excluded to prevent direct target leakage.
...
|---|---:|---:|---:|
| Random Forest | 3.4880 | 8.7689 | 0.3725 |
...
```text
├── australia_rainfall_regression.ipynb
├── README.md
└── Weather Data.csv
```
...
jupyter lab 'australia_rainfall_regression.ipynb'
```
