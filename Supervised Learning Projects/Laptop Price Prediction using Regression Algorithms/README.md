...
Estimate laptop price from manufacturer, hardware and display specifications.
...
- **Target:** `Price`
- **Primary metric:** MAE
- **Goal:** Estimate laptop price from manufacturer, hardware and display specifications.

## Dataset

- **Availability:** Download required: place `laptops_train.csv` in this directory
- **Recorded source:** [https://www.kaggle.com/datasets/arnabchaki/laptop-price-prediction](https://www.kaggle.com/datasets/arnabchaki/laptop-price-prediction)
- **Target:** `Price`
...
- The training file is the single source for model evaluation.
- Unseen categories are handled safely by the pipeline.
...
jupyter lab 'laptop_price_regression.ipynb'
```
