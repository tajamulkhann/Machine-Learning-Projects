...
Build a precision-aware spam classifier that demonstrates modern text pipelines and threshold trade-offs.
...
The notebook is committed with executed outputs. Open [email_spam_detection.ipynb](email_spam_detection.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "email_spam_detection.ipynb"
```
