...
Classify whether a passenger is satisfied from travel context and service ratings.
...
- **Goal:** Classify whether a passenger is satisfied from travel context and service ratings.

## Dataset

- **Availability:** Included: `train.csv`
- **Recorded source:** Dataset files are included in this project.
- **Target:** `satisfaction`
...
- The supplied test.csv is treated as the untouched holdout set.
- Resampling before the train/test split was removed to prevent leakage.
...
```text
├── airline_satisfaction_classification.ipynb
├── README.md
├── train.csv
└── test.csv
```
...
jupyter lab 'airline_satisfaction_classification.ipynb'
```
