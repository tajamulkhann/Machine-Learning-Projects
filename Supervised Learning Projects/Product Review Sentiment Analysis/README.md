...
Convert customer reviews into sentiment signals for product teams without hiding class-level performance.
...
The notebook is committed with executed outputs. Open [product_review_sentiment.ipynb](product_review_sentiment.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "product_review_sentiment.ipynb"
```
