...
Classify news-like text while documenting uncertainty, source verification, and the limits of linguistic signals.
...
The notebook is committed with executed outputs. Open [fake_news_detection_nlp.ipynb](fake_news_detection_nlp.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "fake_news_detection_nlp.ipynb"
```
