...
Classify chronic kidney disease status from clinical measurements and examination results.
...
- **Goal:** Classify chronic kidney disease status from clinical measurements and examination results.

## Dataset

- **Availability:** Download required: place `new_model.csv` in this directory
- **Recorded source:** [https://www.kaggle.com/datasets/abhia1999/chronic-kidney-disease](https://www.kaggle.com/datasets/abhia1999/chronic-kidney-disease)
- **Target:** `Class`
...
- Missing clinical values are imputed within the pipeline.
- The notebook reports recall and false negatives, not accuracy alone.
...
```text
├── chronic_kidney_disease_classification.ipynb
└── README.md
```
...
jupyter lab 'chronic_kidney_disease_classification.ipynb'
```
