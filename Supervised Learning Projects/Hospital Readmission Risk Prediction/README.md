...
Identify patients who may need additional post-discharge support using recall-aware evaluation.
...
The notebook is committed with executed outputs. Open [hospital_readmission_risk.ipynb](hospital_readmission_risk.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "hospital_readmission_risk.ipynb"
```
