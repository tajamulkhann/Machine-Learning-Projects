...
Route incoming support tickets to the right team with a multiclass NLP model and interpretable terms.
...
The notebook is committed with executed outputs. Open [customer_support_ticket_routing.ipynb](customer_support_ticket_routing.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "customer_support_ticket_routing.ipynb"
```
