...
Estimate claim cost severity for reserving workflows with robust error metrics and human review.
...
The notebook is committed with executed outputs. Open [insurance_claim_severity.ipynb](insurance_claim_severity.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "insurance_claim_severity.ipynb"
```
