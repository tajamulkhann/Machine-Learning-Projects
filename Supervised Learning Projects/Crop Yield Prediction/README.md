...
Predict crop yield from environmental and farm-management features with uncertainty-aware interpretation.
...
The notebook is committed with executed outputs. Open [crop_yield_prediction.ipynb](crop_yield_prediction.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "crop_yield_prediction.ipynb"
```
