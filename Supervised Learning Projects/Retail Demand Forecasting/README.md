...
Forecast daily unit demand with chronological validation, calendar signals, promotions, and a naive baseline.
...
The notebook is committed with executed outputs. Open [retail_demand_forecasting.ipynb](retail_demand_forecasting.ipynb) to inspect the actual model comparison, plots, holdout metrics, diagnostics, and sample predictions generated from the reproducible demo data.
...
jupyter lab "retail_demand_forecasting.ipynb"
```
