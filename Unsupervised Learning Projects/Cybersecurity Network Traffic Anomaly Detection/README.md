...
Prioritize unusual network flows from volume, duration, ports, failed connections, byte ratios, and fan-out behavior.

## Project status

- **Portfolio decision:** New
- **Learning type:** Unsupervised learning
- **Core method:** Isolation Forest and Local Outlier Factor with robust scaling and PCA
...
A deterministic normal-behavior dataset with rare injected stress cases is generated inside the notebook. Scenario flags are excluded from training.
...
```text
├── cybersecurity_network_traffic_anomaly_detection.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/Cybersecurity Network Traffic Anomaly Detection/cybersecurity_network_traffic_anomaly_detection.ipynb"
```
