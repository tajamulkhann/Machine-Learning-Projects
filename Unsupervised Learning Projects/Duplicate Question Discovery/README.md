...
Find semantically similar questions for FAQ consolidation and community moderation using vector similarity.
...
```text
├── duplicate_question_discovery.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/Duplicate Question Discovery/duplicate_question_discovery.ipynb"
```
