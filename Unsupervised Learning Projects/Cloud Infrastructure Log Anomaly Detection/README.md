...
Detect unusual service windows from error rates, latency, restarts, request volume, memory, and CPU behavior.
...
```text
├── cloud_infrastructure_log_anomaly_detection.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/Cloud Infrastructure Log Anomaly Detection/cloud_infrastructure_log_anomaly_detection.ipynb"
```
