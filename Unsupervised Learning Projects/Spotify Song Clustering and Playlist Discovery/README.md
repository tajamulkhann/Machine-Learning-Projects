...
- **Category:** Clustering
- **Goal:** Group tracks by audio characteristics and turn clusters into coherent playlist seeds.
- **Data mode:** Verified demo mode
- **Primary evaluation:** Silhouette, Davies-Bouldin, adjusted Rand index and cluster balance

## Dataset

- **Dataset:** Deterministic Spotify-style audio-feature data with hidden genres for evaluation only.
- **Reference/source:** https://www.kaggle.com/datasets/maharshipandya/-spotify-tracks-dataset
...
- Feature scaling
- K-Means selection
- PCA projection and cluster profiling

## Evaluation

- Silhouette
- Davies-Bouldin
- adjusted Rand index and cluster balance
...
jupyter lab "spotify_song_clustering.ipynb"
~~~
