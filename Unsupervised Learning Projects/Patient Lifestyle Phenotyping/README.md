...
Discover lifestyle phenotypes from activity, sleep, resting pulse, hydration, and stress signals for cohort exploration.
...
```text
├── patient_lifestyle_phenotyping.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/Patient Lifestyle Phenotyping/patient_lifestyle_phenotyping.ipynb"
```
