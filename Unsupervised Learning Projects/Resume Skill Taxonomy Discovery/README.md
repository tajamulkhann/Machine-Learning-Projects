# Resume Skill Taxonomy Discovery

Organize resume skill statements into emerging capability groups for portfolio analysis rather than candidate ranking.
...
```text
├── resume_skill_taxonomy_discovery.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/Resume Skill Taxonomy Discovery/resume_skill_taxonomy_discovery.ipynb"
```
