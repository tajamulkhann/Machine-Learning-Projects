# Customer Support Topic Discovery

Reveal common support themes so teams can improve routing, self-service content, and backlog analysis.
...
```text
├── customer_support_topic_discovery.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/Customer Support Topic Discovery/customer_support_topic_discovery.ipynb"
```
