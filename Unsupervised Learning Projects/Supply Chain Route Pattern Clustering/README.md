...
Cluster logistics lanes by distance, lead time, cost, variability, handling, and emissions intensity.
...
```text
├── supply_chain_route_pattern_clustering.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/Supply Chain Route Pattern Clustering/supply_chain_route_pattern_clustering.ipynb"
```
