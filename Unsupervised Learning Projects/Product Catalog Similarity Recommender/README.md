...
Recommend similar catalog items from product text and metadata without user labels or purchase outcomes.

## Project status

- **Portfolio decision:** New
- **Learning type:** Unsupervised learning
- **Core method:** TF-IDF, cosine nearest neighbours, K-Means, and coverage checks
...
A deterministic product catalog is generated inside the notebook.
...
```text
├── product_catalog_similarity_recommender.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/Product Catalog Similarity Recommender/product_catalog_similarity_recommender.ipynb"
```
