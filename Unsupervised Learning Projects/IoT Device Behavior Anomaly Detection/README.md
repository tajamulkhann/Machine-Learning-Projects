...
Surface compromised or malfunctioning devices from telemetry frequency, payload, battery, errors, destinations, and uptime.
...
```text
├── iot_device_behavior_anomaly_detection.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/IoT Device Behavior Anomaly Detection/iot_device_behavior_anomaly_detection.ipynb"
```
