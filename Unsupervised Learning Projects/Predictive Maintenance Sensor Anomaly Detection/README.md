...
- **Goal:** Detect abnormal equipment states from multivariate sensor readings.
- **Data mode:** Verified demo mode
- **Primary evaluation:** ROC-AUC, average precision, precision at k and alert-rate analysis

## Dataset

- **Dataset:** Deterministic industrial sensor data with hidden failure windows for evaluation only.
- **Reference/source:** https://www.kaggle.com/datasets/shivamb/machine-predictive-maintenance-classification
...
- Isolation Forest
- Local Outlier Factor and sensor-level error inspection

## Evaluation

- ROC-AUC
- average precision
- precision at k and alert-rate analysis
...
jupyter lab "predictive_maintenance_anomalies.ipynb"
~~~
