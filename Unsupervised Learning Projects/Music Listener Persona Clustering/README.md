...
Discover listener personas from session depth, discovery, repeats, skips, playlist saves, and listening-hour diversity.
...
```text
├── music_listener_persona_clustering.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/Music Listener Persona Clustering/music_listener_persona_clustering.ipynb"
```
