...
Segment anonymous shopping sessions by engagement, basket activity, discount use, and purchase cadence.
...
```text
├── ecommerce_shopper_behavior_clustering.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/E-Commerce Shopper Behavior Clustering/ecommerce_shopper_behavior_clustering.ipynb"
```
