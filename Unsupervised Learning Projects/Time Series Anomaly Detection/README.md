...
- **Goal:** Find spikes, drops and level shifts in a seasonal signal without supervised training.
- **Data mode:** Verified demo mode
- **Primary evaluation:** ROC-AUC, average precision, precision at k and event coverage

## Dataset

- **Dataset:** Deterministic seasonal time series with hidden anomalies for evaluation only.
- **Reference/source:** Replace with a timestamped operational metric.
...
- robust z-scores and Isolation Forest

## Evaluation

- ROC-AUC
- average precision
- precision at k and event coverage
...
jupyter lab "time_series_anomaly_detection.ipynb"
~~~
