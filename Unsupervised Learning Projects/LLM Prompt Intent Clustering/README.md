...
Discover recurring prompt intents for routing, evaluation, and prompt-library design without labelled training data.
...
```text
├── llm_prompt_intent_clustering.ipynb
└── README.md
```
...
jupyter lab "Unsupervised Learning Projects/LLM Prompt Intent Clustering/llm_prompt_intent_clustering.ipynb"
```
